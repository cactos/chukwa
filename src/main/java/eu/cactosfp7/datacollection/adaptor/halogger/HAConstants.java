...
public class HAConstants extends AbstractAdaptor {
  static Logger log = Logger.getLogger(HAConstants.class);
  private long period = 60 * 1000;
  private Halogger runner;
  private Timer timer;
  ...
  public void start(long offset) throws AdaptorException {
    if(timer == null) {
      timer = new Timer();
      runner = new Halogger(dest, HAConstants.this);
    }

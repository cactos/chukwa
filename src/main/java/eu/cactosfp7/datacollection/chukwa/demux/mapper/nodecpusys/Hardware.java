 ...
 */
package eu.cactosfp7.datacollection.chukwa.demux.mapper.nodecpusys;
...
import static eu.cactosfp7.datacollection.chukwa.demux.mapper.nodecpusys.HardwareConstants.HARDWARE_COLUMN_NAMES;
import static eu.cactosfp7.datacollection.chukwa.demux.mapper.nodecpusys.HardwareConstants.HARDWARE_HEADER_SPLIT_COLUMNS;
import static eu.cactosfp7.datacollection.chukwa.demux.mapper.nodecpusys.HardwareConstants.hardwareReadSpec;
...
//			String[] rowValues = recordEntry.trim().split("[\\r\\n]+");
			...
			while ((nextLine = reader.readNext()) != null){
				if(!nextLine[0].equals("DATE") && nextLine.length==3){
					log.info("sys:"+filename+" "+nextLine[0]+" "+nextLine[1]+" "+nextLine[2]);
...
//			AbstractProcessorConstants.addSingleValue("cpu_cores", totalCores, hardwareElements);
			AbstractProcessorConstants.addSingleValue("cpu_sys", mean_cpu/totalCores, hardwareElements);
			AbstractProcessorConstants.addSingleValue("node_name", filename, hardwareElements);
